...
- `Paired-end Illumina short reads` from the relevant sample set. To download use this links (R1 and R2):__
R1:
https://www.dropbox.com/scl/fi/t1tobffzz5jbjycxe7cqp/S474_R_S179_R1_001.fastq.gz?rlkey=86dutksm8qfwao5sb0j2rdg2u&dl=0__
R2:
