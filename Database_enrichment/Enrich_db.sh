...
## this script will receive a fasta/fastq file prepared after using the script "Prepare_raq_sequences.sh", will remove redundant sequences and cluster against a chosen database to find sequences
